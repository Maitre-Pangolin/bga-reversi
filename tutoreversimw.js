 ...
 * tutoreversimw.js
 *
 * tutoReversiMw user interface script
 *
...
define(["dojo", "dojo/_base/declare", "ebg/core/gamegui", "ebg/counter"], function (dojo, declare) {
  return declare("bgagame.tutoreversimw", ebg.core.gamegui, {
    constructor: function () {
      console.log("tutoreversimw constructor");
...
*/
    ...
    onPlayDisc: function (evt) {
      ...
      if (this.checkAction("playDisc")) {
        ...
        this.ajaxcall(
          "/tutoreversimw/tutoreversimw/playDisc.html",
          {
            x: x,
            y: y,
          },
    ...
    /* Example:
        ...
        onMyMethodToCall1: function( evt )
        {
            ...
            this.ajaxcall( "/tutoreversimw/tutoreversimw/myAction.html", { 
                                                                    lock: true, 
                                                                    myArgument1: arg1, 
                                                                    myArgument2: arg2,
                                                                    ...
    ...
    /*
            ...
            Note: game notification names correspond to "notifyAllPlayers" and "notifyPlayer" calls in
                  your tutoreversimw.game.php file.
